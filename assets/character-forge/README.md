...
Every Idle holds runtime frame 6 for 1500 ms and runtime frame 13 for 1500 ms
before frame 25. `frame_durations_ms` in `sheet_specs.json` is authoritative;
...
incomplete Low-view component. Its exact eight-frame Front Run artwork is live;
un-authored directions and motions remain transparent. Character Forge supports
